...
export const routes: Routes = [
  ...
  { path: 'animal/create', redirectTo: 'animals/create', pathMatch: 'full' },
  { path: 'create-animal', redirectTo: 'animals/create', pathMatch: 'full' },
  { path: 'animals/add', redirectTo: 'animals/create', pathMatch: 'full' },
  ...
  { path: 'animal/:id', redirectTo: 'animals/:id', pathMatch: 'full' },

  { path: 'favourites', loadComponent: () => import('./features/animals/favourite-animals/favourite-animals.component').then(c => c.FavoriteAnimalsComponent), canActivate: [authGuard, roleGuard], data: { roles: ['User'] } },
  { path: 'favorites', redirectTo: 'favourites', pathMatch: 'full' },
  { path: 'favorite', redirectTo: 'favourites', pathMatch: 'full' },
  ...
  { path: 'adopt/:animalId', loadComponent: () => import('./features/adoption/apply/apply.component').then(c => c.ApplyComponent), canActivate: [authGuard, roleGuard], data: { roles: ['User'] } },
